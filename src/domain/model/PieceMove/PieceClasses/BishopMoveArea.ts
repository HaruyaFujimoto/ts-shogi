...
export class BishopMoveArea implements IPieceMoveArea {
  ...
  public get_square_positions_as_on_diagram(
    ...
    const up_right_position_list_width_diagram =
      PieceMoveOnDiagram.sliece_in_where_can_move_on_diagram_for_long_piece(
        up_right_position_list,
        current_position,
        diagram
      );
    const down_right_position_list_width_diagram =
      PieceMoveOnDiagram.sliece_in_where_can_move_on_diagram_for_long_piece(
        down_right_position_list,
        current_position,
        diagram
      );
    const up_left_position_list_width_diagram =
      PieceMoveOnDiagram.sliece_in_where_can_move_on_diagram_for_long_piece(
        up_left_position_list,
        current_position,
        diagram
      );
    const down_left_position_list_width_diagram =
      PieceMoveOnDiagram.sliece_in_where_can_move_on_diagram_for_long_piece(
        down_left_position_list,
        current_position,
        diagram
    ...
    // 各方向の移動範囲を結合する
    const square_position_list: SquarePosition[] =
      up_right_position_list_width_diagram.concat(
