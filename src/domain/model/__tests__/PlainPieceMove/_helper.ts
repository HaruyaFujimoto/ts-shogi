...
export function move_area_test(piece_type: PieceType, piece_master: PlayerType, current_position: SquarePosition, expect_pair_list: number[][]) {
  // PieceMove 生成
  let piece_move = new PlainPieceMove(piece_type, current_position, piece_master);
