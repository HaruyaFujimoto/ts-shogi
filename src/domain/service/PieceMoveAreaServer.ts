...
export class PieceMoveAreaServer {
  static get_move_area(square: Square, diagram: Diagram) {
    ...
    const move_area: SquarePosition[] = PieceMoveAreaFactory.factory(piece.type).get_square_positions_as_on_diagram(square.position, diagram);
    return move_area;
  }

  static is_target_square_in_move_area(selected_square: Square, target_square: Square, diagram: Diagram) {
    ...
    const move_area: SquarePosition[] = PieceMoveAreaFactory.factory(piece.type).get_square_positions_as_on_diagram(selected_square.position, diagram);
